...
<html lang="en">
<head>
	<title>SIMPLE LOAD SCREEN V 0.1</title>
	<meta charset="utf-8">
...
<body>
	<div id="wrapper">
		<div id="main">
			<div class="inner">
				<h1 id="text02 title">github.com/RavokTHC</h1>
				<p id="text01 desc" style="font-size:30px;">github.com/RavokTHC</p>
				<p id="rules">Obedeça as Regras!</p>
				<hr id="divider02">
				<p id="text01">Conectando ao Servidor...</p>
